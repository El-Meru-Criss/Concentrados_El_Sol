            ...
            <div class="card text-center h-100">
              ...
              <div class="card-body">
                ...
                <div style="max-height: 10rem; overflow: auto;">
                  ...
                  <?php $num_proveedores += 1; } ?>
                  
                </div>
              </div>
              <div class="card-footer">
                <div class="input-group p-2">
                  <button onclick="eliminar_producto(<?php echo $pro['idproducto'] ?>,<?php echo $num_proveedores ?>)" type="button" class="btn btn-outline-danger col"><i class="fa-solid fa-trash"></i> Eliminar</button>
                </div>
              </div>
            </div>
          </DIv>
